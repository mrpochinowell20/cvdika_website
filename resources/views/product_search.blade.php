...
@section('content')
    <div class="row mb-3">
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-4">
                    <div class="card">
                        <div class="col-12 text-center mb-3"><h3><b><br>MITSUBISI PAJERO SPORT DAKAR</h3></b>Klik untuk detail
                        </div>
                        <div class="card-body">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="col-12 text-center mb-3"><h3><b><br>HONDA JAZZ RS</h3></b>klik untuk detail
                        </div>
                        <div class="card-body">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="col-12 text-center mb-3"><h3><b><br>TOYOTA AVANZA G BARONG</h3></b>klik untuk detail
                        </div>
                        <div class="card-body">
    ...
    <div class="row mb-3">
        <div class="col-4">
            <div class="d-flex mb-0 px-1">
                <h1>Berikut Hasil Pencarian {{ $searchTerm }}</h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="whatsapp-area wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                    ...
                    <div class="kolom-konten text-center"><br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5><b>Harga</b><br>Rp. 314.000.000,00</h5>
                                <p>
                                    <b>Deskripsi Produk</b><br>Produk di atas merupakan contoh produk dari kendaraan yang
                                    kami sediakan, anda dapat melihat detail produk kendaraan tersebut dengan teknologi 360
                                    derajat yang kami sediakan. dan jikalau anda berkenan dan tertarik pada kendaraan yang
                                    ada pada display kami, anda dapat menghubungi layanan kami atau berkunjung langsung ke
                                    tempat kami.
                                </p>
                            </div>
                        </div>
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="kolom-konten text-center"><br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3><b>Nama Produk</b><br>JAZZ RS</h3>
                                <h4><b>Tahun</b><br>2013</h4>
                                <h5><b>Harga</b><br>Rp. 173.000.000,00</h5>
                                <p>
                                    <b>Deskripsi Produk</b><br>Produk di atas merupakan contoh produk dari kendaraan yang
                                    kami sediakan, anda dapat melihat detail produk kendaraan tersebut dengan teknologi 360
                                    derajat yang kami sediakan. dan jikalau anda berkenan dan tertarik pada kendaraan yang
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="kolom-konten text-center"><br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3><b>Nama Produk</b><br>TOYOTA AVANZA G 1.3 BARONG</h3>
