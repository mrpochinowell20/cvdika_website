            ...
            <div>
                <form action="" method="post">
                    <div class="grid grid-cols-1 px-8 py-20 bg-white rounded-r-xl">
                        ...
                        <input type="text" placeholder="Username" class="border-b-2 border-cyan-500 focus:outline-none font-semibold placeholder:font-normal text-lg px-1 py-2 mb-4">
                        <input type="text" placeholder="Password" class="border-b-2 border-cyan-500 focus:outline-none font-semibold placeholder:font-normal text-lg px-1 py-2 mb-10">
